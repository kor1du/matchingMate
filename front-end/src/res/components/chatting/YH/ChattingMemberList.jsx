  ...
  if (member.memberId === roomHost) {
      ...
      <>
        <div className="host">
          <div className="report-icon">
            {member.memberId === myId ? null : (
              <span
                onClick={() => {
                  openReportModal();
                }}
              >
                <NotificationImportantIcon sx={{ color: "red", width: 25 }} />
              </span>
            )}
          </div>
          <img
    ...
    return (
      <div className="member">
        ...
        <div className="priority">{member.priority === 2 ? <h4 className="me">나</h4> : null}</div>
        <ChattingInfoModal infoShow={infoShow} setInfoShow={setInfoShow} member={member}></ChattingInfoModal>
        <ReportModal
          infoShow={reportShow}
          setInfoShow={setReportShow}
