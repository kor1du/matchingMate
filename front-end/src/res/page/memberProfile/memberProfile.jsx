...
export default function MemberEdit() {
  ...
  const updateMember = () => {
    ...
    if (address == "" || birthday == "" || phoneNum == "" || password == "") alert("빈값 존재함");
    else {
      const data = {
        address: address,
        birthday: birthday,
      ...
      axios({
        ...
        url: `https://c0f9-1-235-210-229.jp.ngrok.io/myAccount/update`,
        data: data,
        headers: {
          Authorization: token,
    ...
    <ThemeProvider theme={theme}>
      ...
      <Container className={styles.pullDown} component="main" maxWidth="sm" sx={{ mb: 4, boxShadow: 10 }}>
        ...
        >
          ...
          >
            <p>
              아이디 : <span style={{ fontSize: 35 }}>{member.userId}</span>
            </p>
          </Typography>
